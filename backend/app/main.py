...
def startup():
    ...
    seed_catalog = [
        ...
        ("matlab", "MATLAB", "MATLAB con GPU vía noVNC — imagen pre-configurada (desktop xfce + lanzador MATLAB en el Desktop)",
         "k3slab-matlab:r2024a-config", "4", "16Gi", True, "6080", "web", ""),
